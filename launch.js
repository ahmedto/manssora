...
fbl_otp += '<iframe src="//www.facebook.com/plugins/likebox.php?id=' + lb_l_ret.fb_id +'&amp;width=' + '390' + '&amp;height=' + '255' +'&amp;colorscheme=light&amp;show_faces=true&amp;border_color&amp;stream=false&amp;header=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:' + '390' + 'px; height:' + '255' + 'px;" allowTransparency="true"></iframe>';
fbl_otp +='</div></div>';
return fbl_otp;
}
